...
//
//  Created by srivatsa s pobbathi on 16/03/19.
...
@synthesize lblName,lblValue,lblLine,imgArrow,txtName,txtZip,lblZipLine,lblPositionMsg,lblLastReport;
- (void)awakeFromNib {
    [super awakeFromNib];
    // Initialization code
}
